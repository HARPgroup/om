...
// Parse the JSON to get a base element
// Load the destination element or create a new element from the object_class of the base element .
// Set attributes:
  // Iterate through all first level attributes
  // Set those attributes on the destination object. 
  // ** This code will move to the OM object classes eventually, callable by method:
  //    setObjectProps()
  //      which will call setProp() iteratively 
